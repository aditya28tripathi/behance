...
<a href="#" className="font-bold text-blue-600 hover:underline ml-1">
    ...
    <div className="flex space-x-2">
            <button className=" p-2 rounded-full hover:bg-gray-200"> <a href="https://www.facebook.com/"> <FaFacebook className='w-6 h-6'/></a> </button>
            <button className=" p-2 rounded-full hover:bg-gray-200"> <a href="https://www.google.co.in/"> <FcGoogle className='w-6 h-6'/></a></button>
            <button className=" p-2 rounded-full hover:bg-gray-200"> <a href="https://www.apple.com/in/"><GrApple  className='w-6 h-6'/></a></button>
          </div>
        </div>
      </div>
      ...
      <div className="w-full mt-24 border-t-4 border-gradient">
        <div className="text-center p-4 text-m">
          ...
          <a href="#" className="text-blue-600 hover:underline ml-1 font-bold"> {' '}Start your 7 day free trial    </a>
        </div>
      </div>
    </div>
  );
